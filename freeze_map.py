# -*- coding: utf-8 -*-
"""
Created on Tue May 26 19:12:54 2020
...
from tesnorflow.python.tools import freeze_graph,optimize_for_interference_lib
freeze_graph.freeze_graph(input_graph='mnist_model.pbtxt',
                         input_saver='',
                         input_bianry=True,
                         input_checkpoint='mnist_model.ckpt',
                         output_node_name='y_actual',
                         restore_op_name='save/restore_all',
                         filename_tensor_name='save/Const:0',
                         output_graph='frozen_mnist_model.pd',
                         clear_device=True,
                         initializer_nodes='')
input_graph_def=tf.GraphDef()
with tf.gfile.open('frozen_mnist_model.pd','rb')as f:
    data=f.read()
